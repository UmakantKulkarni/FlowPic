...
np.save(os.path.join('output', '{}_x_train'.format(traffic_file_type)), X_train)
del X_train
np.save(os.path.join('output', '{}_y_train'.format(traffic_file_type)), y_train)
del y_train
np.save(os.path.join('output', '{}_x_test'.format(traffic_file_type)), X_test)
del X_test
np.save(os.path.join('output', '{}_y_test'.format(traffic_file_type)), y_test)
del y_test
np.save(os.path.join('output', '{}_x_val'.format(traffic_file_type)), X_val)
del X_val
np.save(os.path.join('output', '{}_y_val'.format(traffic_file_type)), y_val)
del y_val
